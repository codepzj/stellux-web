import type { PageReq, PageResponse, Response } from '@/entities/admin/types/dto'
import type {
...
import type {
  ...
  FriendUpdateReq,
  FriendVO,
} from '@/entities/admin/types/friend'
import type {
  CreateLabelReq,
  EditLabelReq,
  LabelPageReq,
  LabelVO,
} from '@/entities/admin/types/label'
import type { PostDetailVO, PostListType, PostReq, PostVO } from '@/entities/admin/types/post'
import type {
  CreateUserReq,
  LoginReq,
  LoginVO,
  ...
  UpdateUserReq,
  UserInfoVO,
} from '@/entities/admin/types/user'
...
export const updatePostPublishStatusAPI = (client: AdminClient, id: string, is_publish: boolean) =>
...
export const getRootDocumentListAPI = (client: AdminClient, params: PageReq) =>
  client<PageResponse<DocumentRootVO>['data'] | DocumentRootVO[]>('/admin/document/list', {
    params,
  })
...
export const getDocumentContentByDocumentIdAPI = (client: AdminClient, documentId: string) =>
  client<DocumentContentVO[]>('/admin/document-content/all', {
