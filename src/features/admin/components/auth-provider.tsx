...
import { getUserInfoAPI, userLoginAPI, type AdminClient } from '@/entities/admin/api'
import { ADMIN_DEFAULT_PATH, ADMIN_LOGIN_PATH } from '@/entities/admin/routes'
import { adminRequest, isAdminAuthError } from '@/entities/admin/request'
import type { LoginReq, UserInfoVO } from '@/entities/admin/types/user'
...
export function useAdminAuth() {
  const context = React.use(AdminAuthContext)
  if (!context) {
