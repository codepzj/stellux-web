...
import type { BlogListPagination } from '@/shared/lib/blog-list'
import { buildBlogListQuery, getPaginationWindow, paginationFilters } from '@/shared/lib/blog-list'
...
export function BlogListSection({
  ...
  const nextPage = pagination.page_no < pagination.total_page ? pagination.page_no + 1 : null
